...
export default function OnlineJournal() {
    ...
    useEffect(() => {
        document.title = "Reforming Research  | Maurya Education and Research Foundation";
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', marginTop: '15px' }}>
                                ...
                                <div className="spec-item">
                                    ...
                                    <div className="spec-value"><span className="badge badge-accent" style={{ margin: 0, padding: '3px 10px' }}>..............</span></div>
                                </div>
                                <div className="spec-item">
